...
SESSION_NAME="barotrauma"
SCRIPT_DIR=$(dirname "$(realpath "$0")")
START_SCRIPT="$SCRIPT_DIR/DedicatedServer"
START_ARGS=""
...
tmux select-pane -t "$SESSION_NAME".0 -T "Barotrauma Server"

echo "Barotrauma server started in tmux session: $SESSION_NAME"
